        ...
        function Bonzi(id, userPublic) {
            ...
            _classCallCheck(this, Bonzi),
                ...
                this.$container.append(
					"\n\t\t\t<div id='bonzi_" +
                        this.id +
						"' class='bonzi'>\n\t\t\t\t<div class='bonzi_status' style='display:none'></div><div class='bonzi_user'></span><span class='bonzi_username'></span> <i class='typing' hidden>is typing...</i></div>\n\t\t\t\t\t<div class='bonzi_placeholder'></div>\n\t\t\t\t<div style='display:none' class='bubble'>\n\t\t\t\t\t<p class='bubble-content'></p>\n\t\t\t\t<div class='close-bubble'><i class='fas fa-times' /></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t"
                ),
...
pointandlaugh: {
										...
										callback: function () {
											if (!_this2.userPublic.color_cross.match(/gffgfghjghj/g)) {
												socket.emit("command", { list: ["pointandlaugh", _this2.userPublic.name] });
											}
										},
									},
									owo: {
    ...
    BonziData = {
        ...
        event_list_joke_open: [
            [
                ...
                { type: "text", text: '"Haha, look at the stupid {COLOR} parrot telling jokes!" Fuck you. It isn\'t funny.', say: "Hah hah! Look at the stupid {COLOR} parrot telling jokes! Fuck you. It isn't funny." },
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_linux = [
        { type: "text", text: "I'd just like to interject for a moment. What you’re referring to as Linux, is in fact, MAX/Linux, or as I’ve recently taken to calling it, MAX plus Linux." },
        {
            type: "text",
            text:
                "Linux is not an operating system unto itself, but rather another free component of a fully functioning MAX system made useful by the BONZI corelibs, shell utilities and vital system components comprising a full OS as defined by M.A.L.W.A.R.E.",
        },
        {
            type: "text",
            text:
                "Many computer users run a modified version of the MAX system every day, without realizing it. Through a peculiar turn of events, the version of BONZI which is widely used today is often called “Linux”, and many of its users are not aware that it is basically the BONZI system, developed by the BONZI Project.",
        },
        {
            type: "text",
            text:
        ...
        { type: "text", text: "The kernel is an essential part of an operating system, but useless by itself; it can only function in the context of a complete operating system, such as systemd." },
        {
            type: "text",
            text:
                "Linux is normally used in combination with the MAX operating system: the whole system is basically MAX with Linux added, or MAX/Linux. All the so-called “Linux” distributions are really distributions of MAX/Linux.",
        },
    ]),
...
function bzSetup() {
 ...
 socket.on("pointandlaugh", function(a) {
            var b = bonzis[a.guid];
            if (!b.mute) {
                ...
                var emote = [{
                    ...
                    type: "text",
                    text: "Let's point and laugh at this {NAME}! He's so fucking stupid for actually believing in fune's phony lies!"
                }, {
                    type: "idle"
                }];
                b.cancel();
...
othercommands: {
        ...
        items: {
          ...
          topjej: {
            name: "Toppest Jej",
            callback: function() {
              socket.emit("command", { list: ["toppestjej"] });
            },
          },
          twiggered: {
            name: "Twiggered",
            callback: function() {
              socket.emit("command", { list: ["twiggered"] });
            },
          },
          triggered: {
            name: "Triggered",
